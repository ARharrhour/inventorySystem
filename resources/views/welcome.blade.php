...
<body id="page-top">
    <div id="app">
        <div id="wrapper">
            ...
            <!-- Sidebar -->
            <nav id="sidebar" v-show="$route.path === '/' || $route.path === '/register' || $route.path === '/forget' ? flase : true" style="display: none">
            <ul class="navbar-nav sidebar sidebar-light accordion" id="accordionSidebar">
                ...
                <li class="nav-item">
                    ...
                    <div id="collapseEmployees" class="collapse" aria-labelledby="headingBootstrap"
                        ...
                        <div class="bg-white py-2 collapse-inner rounded">
                            <router-link class="collapse-item" to="/employee/store">Create Employee</router-link>
                 ...
                 <li class="nav-item">
                    ...
                    <div id="collapseSuppliers" class="collapse" aria-labelledby="headingBootstrap"
                        data-parent="#accordionSidebar">
                        <div class="bg-white py-2 collapse-inner rounded">
                          <router-link class="collapse-item" to="/supplier/store">Create Supplier</router-link>
                 ...
                 <li class="nav-item">
                    ...
                    <div id="collapseCategories" class="collapse"
                        data-parent="#accordionSidebar">
                        <div class="bg-white py-2 collapse-inner rounded">
                             <router-link class="collapse-item" to="/category/store">Create Category</router-link>
                ...
                <li class="nav-item">
                    ...
                    <div id="collapseProducts" class="collapse"
                        data-parent="#accordionSidebar">
                        <div class="bg-white py-2 collapse-inner rounded">
                             <router-link class="collapse-item" to="/product/store">Create Product</router-link>
                ...
                <li class="nav-item">
                    ...
                    <div id="collapseCustomers" class="collapse"
                        data-parent="#accordionSidebar">
                        <div class="bg-white py-2 collapse-inner rounded">
                             <router-link class="collapse-item" to="/customer/store">Create Customer</router-link>
                            <router-link class="collapse-item" to="/customer">All Customers</router-link>
                        </div>
                    </div>
                </li>
                {{-- end Customers navigation--}}
                {{-- expenses --}}
                <li class="nav-item">
                    ...
                    <div id="collapseExpenses" class="collapse"
                        data-parent="#accordionSidebar">
                        <div class="bg-white py-2 collapse-inner rounded">
                             <router-link class="collapse-item" to="/expense/store">Add Expense</router-link>
                            <router-link class="collapse-item" to="/expense">All Expenses</router-link>
                        </div>
                    </div>
                </li>
                {{-- end expenses navigation--}}
                 {{-- Salaries --}}
                <li class="nav-item">
                    ...
                    <div id="collapseSalaries" class="collapse"
                        data-parent="#accordionSidebar">
                        <div class="bg-white py-2 collapse-inner rounded">
                             <router-link class="collapse-item" to="/given-salary">Add Salary</router-link>
                            <router-link class="collapse-item" to="/expense">All Salaries</router-link>
                        </div>
                    </div>
                </li>
                {{-- end Salaries navigation--}}
